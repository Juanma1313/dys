...
const commentText = document.getElementById("id_comment"); /*Field element from form*/
 ...
 * - Retrieves the associated comment's ID upon click.
 * - Updates the submit button's text to "Post Replay".
 */

for (let button of replyButtons) {
    button.addEventListener("click", (e) => {
        let commentId = e.target.getAttribute("comment_id");
        submitButton.innerText = "Post Replay";
        submitButton.name="parent"
